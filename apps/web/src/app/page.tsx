...
function EscrowDiagram() {
  return (
    <div className="relative flex h-full min-h-[340px] flex-col items-center justify-center gap-0 overflow-hidden rounded-2xl border border-white/10 bg-surface-high p-8 select-none">
      {/* Background glow */}
      ...
      <div className="relative z-10 flex flex-col items-center py-2">
        ...
        <p className="my-1 rounded-full border border-primary-container/30 bg-primary-container/10 px-3 py-0.5 text-[10px] font-semibold uppercase tracking-widest text-primary">
          Lock Collateral ↓
        </p>
      ...
      <div className="relative z-10 flex w-full max-w-xs flex-col items-center gap-2 rounded-xl border border-primary-container/40 bg-surface p-4 shadow-[0_0_30px_-10px_#7d56fe]">
        ...
        <div className="text-center">
          ...
          <p className="text-[10px] text-on-surface-variant">Locked on Base Sepolia</p>
        </div>
      ...
      <div className="relative z-10 flex flex-col items-center py-2">
        ...
        <p className="my-1 rounded-full border border-secondary-container/30 bg-secondary-container/10 px-3 py-0.5 text-[10px] font-semibold uppercase tracking-widest text-secondary-container">
          QR Handshake ↓
        </p>
